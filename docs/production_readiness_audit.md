...
lifecycle, orchestrator, real Corsa typecheck/type emit coverage, Node binding,
...
- rerun real typecheck and type emit fixtures against the pinned Corsa binary
