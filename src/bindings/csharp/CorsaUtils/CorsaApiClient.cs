...
public sealed class CorsaApiClientOptions
{
...
public sealed class CorsaApiClient : IDisposable
{
    ...
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_spawn")]
    private static extern nint SpawnNative(CorsaStrRef optionsJson);
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_initialize_json")]
    private static extern CorsaString InitializeJsonNative(nint value);
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_parse_config_file_json")]
    private static extern CorsaString ParseConfigFileJsonNative(nint value, CorsaStrRef file);
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_update_snapshot_json")]
    private static extern CorsaString UpdateSnapshotJsonNative(nint value, CorsaStrRef paramsJson);
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_get_source_file")]
    ...
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_get_string_type_json")]
    private static extern CorsaString GetStringTypeJsonNative(nint value, CorsaStrRef snapshot, CorsaStrRef project);
    [DllImport(LibraryName, EntryPoint = "corsa_api_client_type_to_string")]
    ...
    private CorsaApiClient(nint handle) => _handle = handle;

    public static CorsaApiClient Spawn(CorsaApiClientOptions options) =>
        SpawnJson(JsonSerializer.Serialize(options, JsonOptions));

    public static CorsaApiClient SpawnJson(string optionsJson)
    {
        using var value = Utf8Input.FromString(optionsJson);
        var handle = SpawnNative(value.Ref);
        return handle == 0 ? throw CreateException() : new CorsaApiClient(handle);
    }
